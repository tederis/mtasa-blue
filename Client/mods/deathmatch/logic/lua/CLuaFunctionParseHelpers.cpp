...
IMPLEMENT_ENUM_BEGIN(eModelAudioProperties)
ADD_ENUM(MODEL_AUDIO_TYPE, "type")
ADD_ENUM(MODEL_AUDIO_ENGINE_ON, "engine_on")
ADD_ENUM(MODEL_AUDIO_ENGINE_OFF, "ongine_off")
ADD_ENUM(MODEL_AUDIO_HORN_TON, "horn_ton")
ADD_ENUM(MODEL_AUDIO_HORN_HIGH, "horn_high")
ADD_ENUM(MODEL_AUDIO_DOOR, "door")
IMPLEMENT_ENUM_END("model-audio-property-type")
